  ...
  <Layout>
    <div class="hero container-inner mx-auto flex flex-col sm:flex-row justify-between py-16">
      <div class="text-5xl font-bold w-full sm:w-3/5 text-center sm:text-left">
        <div class="leading-tight">Salut, chers createurs</div>
        <div class="text-cyan-700 leading-tight">Bienvenue!</div>
      </div>
    ...
    <div class="container-inner mx-auto">
      <p class="text-lg sm:text-xl">
        <span class="italic">Salute plurimam dicit.</span> Ce site est dedié a la creation, au partage d'Experience et aux passionnés de la tech. 
      </p>
    ...
    <div class="overflow-x-hidden">
      <div class="projects container-inner mx-auto text-xl border-t border-gray-500 border-b py-16 mb-12 mt-12 relative">
        <h2 class="font-bold mb-6" id="projects">Objectifs et Activités:</h2>
        ...
        <ul class="text-lg sm:text-xl space-y-6">
          <li class="checkmark">
            <div>Défis de la semaine</div>
            <div class="text-lg text-gray-600">
              Chaque semaine nous aurons a presenter un projet choisi par vous ou tiré au sort(Voir le blog) et nous vous presenterons notre solution <a href="https://github.com/" target="_blank">Le code sera sur notre Github </a>.
            </div>
          </li>
          <li class="checkmark">
            <div>Actualités Tech</div>
            <div class="text-lg text-gray-600">
             Actualités sur les  dernieres technologies sorties et leurs portées.
            </div>
          </li>
          <li class="checkmark">
            <div>Entrepreneuriat et Idées de business</div>
            <div class="text-lg text-gray-600">
              Actualités sur les nouvelles startup et les idées hors du commun
            </div>
          </li>
          <li class="checkmark">
            <div>Productivité</div>
            <div class="text-lg text-gray-600">
             Nous apprendrons ensemble a etre plus productifs
            </div>
          </li>
