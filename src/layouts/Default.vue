    ...
    <header class="border-t-14 border-cyan-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        >
          ...
          <li>
            <g-link to="/projects" class="text-copy-primary hover:text-gray-600">Actualités</g-link>
          </li>
          <li>
    ...
    <footer class="bg-cyan-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:fougmarc@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.linkedin.com/in/marc-arnaud-soro-646b0a173/" target="_blank" class="text-white hover:text-gray-400">
